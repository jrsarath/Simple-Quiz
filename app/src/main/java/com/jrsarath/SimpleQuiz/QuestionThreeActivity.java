...
public class QuestionThreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.question_three_activity);
        alert = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        dialog.cancel();
                        Intent intent = new Intent(getBaseContext(), QuestionFourActivity.class);
                        ...
                        intent.putExtra("question3_answer", answer);
    ...
    public void answer1(View view) {
        ...
        answer = getString(R.string.question3_answer1);
    }
    public void answer2(View view) {
        toggleBg(R.id.answer2);
        answer = getString(R.string.question3_answer2);
    }
    public void answer3(View view) {
        toggleBg(R.id.answer3);
        answer = getString(R.string.question3_answer3);
    }
    public void answer4(View view) {
        toggleBg(R.id.answer4);
        answer = getString(R.string.question3_answer4);
    }
}
