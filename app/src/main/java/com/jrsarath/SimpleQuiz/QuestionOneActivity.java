...
public class QuestionOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.question_one_activity);
        alert = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        dialog.cancel();
                        Intent intent = new Intent(getBaseContext(), QuestionTwoActivity.class);
                        intent.putExtra("question1_answer", answer);
    ...
    public void answer1(View view) {
        ...
        answer = getString(R.string.question1_answer1);
    }
    public void answer2(View view) {
        toggleBg(R.id.answer2);
        answer = getString(R.string.question1_answer2);
    }
    public void answer3(View view) {
        toggleBg(R.id.answer3);
        answer = getString(R.string.question1_answer3);
    }
    public void answer4(View view) {
        toggleBg(R.id.answer4);
        answer = getString(R.string.question1_answer4);
    }
}
