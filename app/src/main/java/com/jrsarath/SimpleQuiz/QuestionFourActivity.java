...
public class QuestionFourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.question_four_activity);
        alert = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        dialog.cancel();
                        Intent intent = new Intent(getBaseContext(), QuestionFiveActivity.class);
                        ...
                        intent.putExtra("question4_answer", answer);
    ...
    public void answer1(View view) {
        ...
        answer = getString(R.string.question4_answer1);
    }
    public void answer2(View view) {
        toggleBg(R.id.answer2);
        answer = getString(R.string.question4_answer2);
    }
    public void answer3(View view) {
        toggleBg(R.id.answer3);
        answer = getString(R.string.question4_answer3);
    }
    public void answer4(View view) {
        toggleBg(R.id.answer4);
        answer = getString(R.string.question4_answer4);
    }
}
